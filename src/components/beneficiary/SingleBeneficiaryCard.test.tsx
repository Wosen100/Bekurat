...
describe('When long name', () => {
  it('should be substring to 35 char', () => {
    ...
    expect(screen.getByTestId('name_value').textContent).toBe('This is a long name that have more ...');
  });
});
...
describe('Donation values', () => {
  it('Donation values must be with currency value', () => {
    ...
    expect(screen.getByTestId('donation_value').textContent).toBe('$10 raised of $100');
  });
});
