import { InputAdornment, TextField, Grid, Typography, Button } from '@mui/material';
    ...
    <div>
      ...
      <Grid item xs={12}>
        <div style={{ marginTop: '20px' }}>
          <Typography sx={{ mb: 2, fontWeight: 'bold' }}>Enter your donation</Typography>
          <TextField
              ...
              startAdornment: (
                <InputAdornment position='start'>
                  <Grid container justifyContent='center'>
                    <Grid item>
                      <Typography style={{ fontWeight: 'bold', color: 'black' }}>$</Typography>
                    </Grid>
                    <Grid item>
                      <Typography style={{ fontWeight: 'bold', color: 'black' }}> USD</Typography>
                    </Grid>
                  </Grid>
                </InputAdornment>
              ),
